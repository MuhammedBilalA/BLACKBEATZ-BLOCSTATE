...
class MostlyPlayed extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: (BlocBuilder<MostlyPlayedBloc, MostlyPlayedState>(
          builder: (context, state) {
            return state.mostPlayedList.isEmpty
                ? const Center(
                    child: Text(
                      'Play Some Songs',
                      style: TextStyle(
                ...
                : ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      return Padding(
                        ...
                        child: InkWell(
                          onTap: () {
                            playingAudio(state.mostPlayedList, index);
                          ...
                          child: ListtileCustomWidget(
                            ...
                            context: context,
                            title: Text(
                              state.mostPlayedList[index].songName??'unknown',
                            ...
                            subtitle: Text(
                              state.mostPlayedList[index].artist??'unknown',
                            ...
                            trailing1: Hearticon(
                              ...
                              isfav:
                                  favoritelist.contains(state.mostPlayedList[index]),
                            ),
